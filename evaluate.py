...
from train_model import HybridDetector, TextDataset
...
def load_model_and_data(model_path: str, max_len: int = 256):
    ...
    return model, test_loader, test_df, device
...
def main():
    ...
    model, test_loader, test_df, device = load_model_and_data(args.model_path, args.max_len)
